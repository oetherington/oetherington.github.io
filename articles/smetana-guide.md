...
This short article is a simple guide for getting started with
[Smetana](https://github.com/oetherington/smetana).

Smetana is an HTML and CSS generator for Go, designed for server-side webpage
rendering. It features a simple component-like API, support for all HTML5 tags
and strongly-typed styling primitives.
